...
<body>
    <div class="container">
        <div class="header">
            <h1>🍎 MyNetDiary Nutrition Search</h1>
            <p>手動修正・改良されたMyNetDiaryデータベース（1,142項目）専用検索システム</p>
        </div>
        ...
        <div class="content">
            <div class="search-section">
                ...
                <div class="examples">
                    ...
                    <span class="example-btn" onclick="searchExample('beans')">beans</span>
                    <span class="example-btn" onclick="searchExample('beef ribeye')">beef ribeye</span>
                    <span class="example-btn" onclick="searchExample('apples')">apples</span>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const examples = ['chicken breast', 'tomatoes', 'beans', 'beef ribeye', 'apples'];
...
def run_demo(host='0.0.0.0', port=5000, debug=False):
    """デモアプリ起動"""
    logger.info(f"🚀 Starting MyNetDiary Nutrition Search Demo on http://{host}:{port}")
