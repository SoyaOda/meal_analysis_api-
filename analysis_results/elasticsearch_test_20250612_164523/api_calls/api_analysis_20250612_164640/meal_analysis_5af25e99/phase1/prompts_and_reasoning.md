...
## 実行情報
- 実行ID: 5af25e99_phase1
- 開始時刻: 2025-06-12T16:46:40.845226
- 終了時刻: 2025-06-12T16:47:19.587967
- 実行時間: 38.74秒
...
**タイムスタンプ**: 2025-06-12T16:46:40.845313
...
For each ingredient name, provide a fallback_terms array that enables progressive generalization when database searches fail:
• Structure: ["main_noun", "modifier1", "modifier2", ...]
• Example: "Creamy Tomato Dressing" → ["dressing", "tomato", "creamy"]
• Example: "Grilled Chicken Breast" → ["chicken", "breast", "grilled"]
• Example: "Sharp Cheddar Cheese" → ["cheese", "cheddar", "sharp"]
• Search progression: "creamy tomato dressing" → "tomato dressing" → "dressing"
• This ensures the core food item (main noun) is always preserved while allowing graceful degradation of specificity.
  ...
  "dishes": [
    {
      "dish_name": "string",
      "confidence": 0.0-1.0,
      "fallback_terms": ["main_noun", "modifier1", "modifier2"],
      "ingredients": [
        {
...
**タイムスタンプ**: 2025-06-12T16:46:40.845316
