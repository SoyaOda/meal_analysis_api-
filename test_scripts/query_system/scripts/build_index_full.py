# -*- coding: utf-8 -*-
"""
Build FAISS index with all USDA data (5,772 items)
"""
...
def main():
    """Build index with all items"""
    print("=" * 60)
    print("USDA Index Builder (Full - All 5,772 items)")
    print("=" * 60)
    ...
    print(f"\n📊 Building embeddings for all {len(builder.items)} items...")
    ...
    print("\n" + "=" * 60)
    print("✅ Full index build completed!")
    print("=" * 60)
