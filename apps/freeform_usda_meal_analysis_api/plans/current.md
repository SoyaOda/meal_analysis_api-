...
- **次の本筋**: (1) ユーザがドラフト(`golden_set.draft_claude_v2.jsonl`)をレビュー→`golden_set.jsonl`確定→人手κ→合格でゲート化。(2) rubric v3でportion band閾値を明示(残unstable)。naming/conviction/nutrientは相対A/Bに使用可。
